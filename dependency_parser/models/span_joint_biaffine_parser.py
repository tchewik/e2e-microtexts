...
@Model.register("span_joint_biaffine_parser")
class SpanJointBiaffineDependencyParser(Model):
    """
    ...
    def __init__(
        ...
        # self.role_projection_layer = TimeDistributed(Linear(encoder_dim, self.num_roles))
        # self._roles_alpha = [0.] * self.num_roles
        # self._roles_alpha[self.vocab.get_token_index('pro', namespace='roles_tags')] = 0.2
        # self._roles_alpha[self.vocab.get_token_index('opp', namespace='roles_tags')] = 0.8
        # self.roles_theta = roles_theta
    ...
    def make_output_human_readable(
        ...
        for instance_roles, instance_heads, instance_functions, length in zip(roles, heads, functions, lengths):
            ...
            # role_probas.append(instance_roles)
        ...
        # output_dict["predicted_roles_probas"] = role_probas
